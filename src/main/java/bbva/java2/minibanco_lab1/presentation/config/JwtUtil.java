package bbva.java2.minibanco_lab1.presentation.config;
...
//Definimos esta clase con la anotación @Componen para después poder inyectarla
// y utilizarla dentro del ciclo de vida de Spring
