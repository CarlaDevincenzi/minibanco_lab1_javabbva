...
import bbva.java2.minibanco_lab1.presentation.config.JwtUtil;
import bbva.java2.minibanco_lab1.presentation.request.clienteReq.LoginReq;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<Void> login(@RequestBody LoginReq loginRequest) {
